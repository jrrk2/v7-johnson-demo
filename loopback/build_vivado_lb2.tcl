...
read_verilog -sv [list $PRIM/prim_util_pkg.sv $PRIM/prim_count_pkg.sv \
    ...
    $IBEX/vendor/lowrisc_ibex/shared/rtl/bus.sv $IBEX/rtl/system/gpio.sv $IBEX/rtl/system/debounce.sv $IBEX/rtl/system/uart.sv top_lb2.sv]
read_xdc lb.xdc
synth_design -top top_lb2 -part $part -include_dirs $PRIM
opt_design
place_design
route_design
