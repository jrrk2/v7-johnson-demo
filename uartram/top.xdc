# 200 MHz LVDS sysclk (Si5324) on E19/E18, bank 38 HP.  Default clock source.
...
# Si570 programmable USER_CLOCK (USER_CLOCK_P=AK34, USER_CLOCK_N=AL34),
# 156.25 MHz default.  Active only when built with -verilog_define USE_USERCLK
# (+ BAUDDIV=85); otherwise these are redundant unused pin constraints.
...
# 8 user LEDs (GPIO_LED_0..7_LS) = last ADD4 output.
