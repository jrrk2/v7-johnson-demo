...
# (vc707_reflect.v): PCS/PMA -> axis_gmii_rx (CRC32) -> valid-frame counter ->
...
read_verilog -sv [list axis_gmii_rx.sv axis_gmii_tx.sv rgmii_lfsr.sv]
read_verilog pcs_pma_flat.v
read_verilog vc707_reflect.v
...
place_design
route_design
write_checkpoint -force vc707_reflect.dcp
write_bitstream -force vc707_reflect.bit
write_verilog -force -mode design vc707_reflect_netlist.v
set fp [open placement_reflect.txt w]
...
close $fp
report_utilization -file util_reflect.rpt
report_timing_summary -file timing_reflect.rpt -max_paths 3
