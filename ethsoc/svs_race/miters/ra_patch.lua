name = "gig_ethernet_pcs_pma_0_rx_rate_adapt"
files = {"/tmp/eb/patched/rx_rate_adapt_p.v"}
...
print("patched rx_rate_adapt -> " .. svd.miter(svd.pick(spec, name), svd.pick(im, name)))
