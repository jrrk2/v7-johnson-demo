...
local net = svd.flatten_struct(result, "sgmii_soc")
svd.write_netlist_edif(net, (os.getenv("W") or "/tmp/svs_hybrid") .. "/sgmii_soc.edf")
print("WROTE " .. (os.getenv("W") or "/tmp/svs_hybrid") .. "/sgmii_soc.edf")
