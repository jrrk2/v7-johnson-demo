...
local net = svd.flatten_struct(result, "eth_mac_1g__EP1_MFL64")
svd.write_netlist_edif(net, "/tmp/eb/macsim/eth_mac_1g.edf")
print("WROTE /tmp/eb/macsim/eth_mac_1g.edf")
