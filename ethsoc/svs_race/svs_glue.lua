...
local names2 = {"rx_axis_packer","tx_axis_unpacker","async_fifo_wr__DW72_AW5","async_fifo_rd__DW72_AW5"}
local i2 = 1
while i2 <= 4 do
  local M = names2[i2]
  local net = svd.flatten_struct(result, M)
  svd.write_netlist_edif(net, "/tmp/eb/gluesim/" .. M .. ".edf")
  print("WROTE " .. M)
  i2 = i2 + 1
end
