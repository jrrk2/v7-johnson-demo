// blackbox stub for eth_macro: used when synthesising USER logic so
// synth_xilinx cannot touch (or const-fold through) the macro netlist.
// The real implementation (eth_macro_impl_ym.v, yosys pass-through) replaces
// this module at json-merge time.
(* blackbox *)
module eth_macro (
    input  wire         clk_int,
    input  wire         rst_int,
