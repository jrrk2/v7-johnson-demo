...
# rewritten pcs_pma_pristine.v implementation netlist instead of the IP) but
...
read_verilog pcs_pma_pristine.v
...
place_design
route_design
write_checkpoint -force vc707_ethsoc_pristine.dcp
write_bitstream -force vc707_ethsoc_pristine.bit
report_timing_summary -file timing_pristine.rpt -max_paths 3
